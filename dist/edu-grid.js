    ...
    controller: [
      ...
      function ($scope, $log, dataFactoryGrid, $timeout) {
        ...
        $scope.refresh = function () {
          ...
          $scope.searchQuery = '';  //CLEAN formAvancedSearchResult
                                    //$scope.options.formAvancedSearchResult="";
        };
        setTimeout(function () {
          $scope.refresh();
